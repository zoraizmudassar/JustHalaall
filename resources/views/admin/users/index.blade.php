        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form  class="edit-user" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-default" style="background: #ff982f;border: none" type="button" data-dismiss="modal">Cancel</button>
                        <button class="btn btn-warning update-restaurant" style="background: #ff982f;border: none"type="submit">Submit</button>
                    </div>
                </form>
            </div>
        </div>
