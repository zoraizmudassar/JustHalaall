                        ...
                        <div class="col-sm-12">
                            <table class="table table-bordered dataTable" id="dataTable" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                ...
                                <tr role="row">
                                    ...
                                    <th class="sorting sorting_asc" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 80px;">Category</th>
                                ...
                                @foreach($products as $res)
                                    <tr class="odd">
                                        ...
                                        <td>
                                            <img src="{{!empty($res->images) ? asset($res->images) : ""}}" class="embed-responsive" data-image="{{$res->images}}">
                                        </td>
                                        <td>
