...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 justify-content-between">
            <div class="row justify-content-between align-items-center">
                <h6 class="ml-3 font-weight-bold">Term & Conditions</h6>
            </div>
        </div>
        <div class="card-body">
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <button type="button" style="background: #ff982f;
                                                        border: none; " data-id="{{$res}}" class="btn btn-sm btn-success edit-term-btn">
                                                    <i class="fa fa-pencil-alt"></i>
                                                </button>
                                                <button type="button" data-id="{{$res->id}}"
                                                        class="btn btn-sm btn-danger delete-term-btn"><i
    ...
    <div class="modal fade bd-example-modal-lg" id="addtermModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form class="add-term" enctype="multipart/form-data">
                    @csrf
    ...
    <div class="modal fade bd-example-modal-lg" id="edittermModal" tabindex="-1" role="dialog"
         aria-labelledby="exampleModalLabel"
         aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form class="edit-term" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="row mb-3">
                            <div class="col-6">
...
@section('script')
    <script>
        ...
        $(document).ready(function () {
            ...
            $('.edit-term-btn').click(function (e) {
