    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 justify-content-between">
            <div class="row justify-content-between align-items-center">
                <h6 class="ml-3 font-weight-bold">Restaurant Payments</h6>
            </div>
        </div>
        <div class="card-body">
                                ...
                                <thead>
                                    <tr role="row">
                                        <th class="sorting sorting_asc" tabindex="0" aria-controls="dataTable"
                                            ...
                                            style="width: 101px;">Order No</th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                            colspan="1" aria-label="Office: activate to sort column ascending"
                                            style="width: 101px;">Pending Payments</th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                        ...
                                        <div class="modal fade bd-example-modal-lg" id="paymentModal{{$item->id}}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{route('admin.payment.restaurant_pay')}}" method="post" class="detail-form" enctype="multipart/form-data">
                                                        @csrf
