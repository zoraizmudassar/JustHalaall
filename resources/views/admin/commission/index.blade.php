...
@section('title','Order Commissions')
@section('content')
    <!-- START - DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3 justify-content-between">
            <div class="row justify-content-between align-items-center">
                <h6 class="ml-3 font-weight-bold">Order Commissions</h6>
            </div>
        </div>
        <div class="card-body">
                                        ...
                                        <td>
                                            ...
                                            <select data-id="{{$res->id}}" class="custom-select custom-select-sm statusSet" aria-label="Select Status">
                                                @foreach($statuses as $status)
                                                    <option value="{{$status->id}}" {{ $res->status_id == $status->id ? "selected" : "" }}>{{ $status->status }}</option>
                                                @endforeach
                                            </select>
                                        </td>
                                        <td>
