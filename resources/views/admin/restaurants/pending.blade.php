                            ...
                            <table class="table table-bordered dataTable" id="dataTable" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                ...
                                @foreach($restaurants as $res)
                                    <tr class="odd">
                                        ...
                                        <td>{{$res->phone}}</td>
                                        <td>{{$res->address}}</td>
                                        <td><select data-id="{{$res->id}}" class="custom-select form-select statusSet" style="width: auto" aria-label="Select Status">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-6">
                                <div class="form-group">
                                    <label>Phone</label>
                                    <input type="text" name="phone" class="form-control form-control-sm" placeholder="EX : +00-00000-0">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                            ...
                            <div class="col-6 d-flex">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-12 pr-2 pl-0">
                                        <input type="text" name="delivery_charges" class="form-control form-control-sm" placeholder="Delivery charges">
                                    </div>
                                </div>
                            </div>
                        </div>
