...
@section('title','Rejected Restaurant')
@section('content')
    <style>
        .form-control{
            height: auto;
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 justify-content-between">
            <div class="row justify-content-between align-items-center">
                <h6 class="ml-3 font-weight-bold">Restaurants</h6>
            </div>
        </div>
        <div class="card-body">
                        ...
                        <div class="col-sm-12">
                            <table class="table table-bordered dataTable" id="dataTable" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                ...
                                <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 43px;">Address</th>
                                ...
                                @foreach($restaurants as $res)
                                    <tr class="odd">
                                        ...
                                        <td>{{$res->phone}}</td>
                                        <td>{{$res->address}}</td>
                                        <td><select data-id="{{$res->id}}"  style="width: auto"  class="custom-select custom-select-sm statusSet" aria-label="Select Status">
                                        ...
                                        <td><img src="{{!empty($res->logo) ? asset($res->logo) : ""}}" class="embed-responsive"></td>
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <button type="button" style="background: #ff982f;border: none" data-id="{{$res}}" class="btn btn-sm btn-success edit-restaurant-btn"><i class="fa fa-pencil-alt"></i></button>
                                                <button type="button" data-id="{{$res->id}}" class="btn btn-sm btn-danger delete-restaurant-btn"><i class="fa fa-trash-alt"></i></button>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
                    ...
                    <div class="modal-body">
                        <div class="row mb-3">
                            <div class="col-6">
                                <div class="form-group">
                                    <label>Name</label>
                                    <input type="text" name="name" class="form-control form-control-sm" placeholder="New Restaurant">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label>Email</label>
                                    <input type="email" name="email" autocomplete="" class="form-control form-control-sm" placeholder="EX : example@example.com" autocomplete="false">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone"  class="form-control form-control-sm onlynumber" placeholder="EX : +00-00000-0">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label>Password</label>
                                    <input type="password" name="password" autocomplete="" class="form-control form-control-sm" placeholder="Password" autocomplete="false">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-6">
                                <div class="form-group">
                                    <label>Address</label>
                                    <input type="text" name="address" class="form-control form-control-sm" placeholder="Ex : New York USA">
                                </div>
                            </div>
                            <hr>
                            <div class="col-6 d-flex">
                                <div class="form-group">
                                    <label>Delivery Time</label><small class="text-danger">Only Digit's</small>
                                    <div class="col-12 pr-10 pl-0">
                                        <input type="text" name="delivery_time" class="form-control form-control-sm onlynumber" placeholder="Delivery time">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Delivery Charges</label><small class="text-danger">Only Digit's</small>
                                    <div class="col-12 pr-2 pl-0">
                                        <input type="text" name="delivery_charges" class="form-control form-control-sm onlynumber" placeholder="Delivery charges">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                                ...
                                <div class="form-group">
                                    <div class="d-flex">
                                        <div class="col-6 pr-2 pl-0">
                                            ...
                                            <input type="time" name="start_time" class="form-control form-control-sm" placeholder="Start Time">
                                        </div>
                                        <div class="col-6 pl-2 pr-0">
                                            <label>Close Time</label>
                                            <input type="time" name="end_time" class="form-control form-control-sm" placeholder="End Time"
                                            >
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="custom-file">
                                    ...
                                    <input type="file" style="height: auto;" name="logo" id="customFileEg1" class="form-control" onchange="loadFile(event)">
                ...
                <form  class="edit-restaurant" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" id="email"  class="form-control form-control-sm" placeholder="Enter Restaurant Address">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            {{--                            <div class="col-6">--}}
                            {{--                                <div class="form-group">--}}
                            {{--                                    <label class="t" for="exampleFormControlInput1"></label>--}}
        ...
        $(document).ready(function(){
            ...
            $('.toggle-class').change(function() {
                ...
                $.ajax({
                    type:'POST',
                    dataType:'json',
                    url:'{{url('/admin/restaurants/change-status')}}',
