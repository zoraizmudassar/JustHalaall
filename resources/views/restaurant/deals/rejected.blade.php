...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 justify-content-between">
            <div class="row justify-content-between align-items-center">
                <h6 class="ml-3 font-weight-bold">Rejected Deals</h6>
            </div>
        </div>
        <div class="card-body">
    ...
    {{--                            <div class="col-6">--}}
    {{--                                <div class="form-group">--}}
    {{--                                    <label class="input-label" for="exampleFormControlInput1">Delivery Time</label>--}}
        ...
        $(document).ready(function(){
            ...
            $('.add-deal').on('submit',function (e){
                ...
                $.ajax({
                    type:'POST',
                    dataType:'json',
                    url:'{{route('restaurants.deal.store')}}',
                    data:data,
                    cache: false,
                    contentType: false,
                    processData: false,
