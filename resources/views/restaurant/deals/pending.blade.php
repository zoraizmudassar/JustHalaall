                                ...
                                @foreach($deals as $res)
                                    <tr>
                                        ...
                                        @if($res->status == 'approved')      
                                            <td>
                                                <input data-id="{{$res->id}}" id="check" class="toggle-class" type="checkbox" data-onstyle="warning" data-offstyle="danger" data-toggle="toggle" data-on="Enable" data-off="Disable" {{ $res->status == 1 ? 'checked' : '' }}>
                                            </td>
                                        @else
                                        <td>                                            
                                        </td>
