    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 justify-content-between">
            <div class="row justify-content-between align-items-center">
                <h6 class="ml-3 font-weight-bold">Approved Deals</h6>
{{--                                <button class="btn btn-sm" style="background: #ff982f;border: none;color: #ffffff" data-toggle="modal" data-target=".bd-example-modal-lg"><i class="fa fa-plus"></i> Add New Deal's</button>--}}
            </div>
        </div>
        <div class="card-body">
...
{{--                                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 101px;">Deal Name</th>--}}
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 43px;">Availablity</th>
                                ...
                                @foreach($deals as $res)
                                    <tr class="odd">
                                        ...
                                        <td>
                                            {{--                                            <input data-id="" id="check" class="toggle-class" type="checkbox" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Active" data-off="InActive" >--}}
                                            <input data-id="{{$res->id}}" id="check" class="toggle-class" type="checkbox" data-onstyle="warning" data-offstyle="danger" data-toggle="toggle" data-on="Available" data-off="UnAvailable" {{ $res->is_available ? 'checked' : '' }}>
    ...
    <div class="modal fade bd-example-modal-lg" id="addDealModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
         aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form  class="add-deal" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label class="input-label" for="exampleFormControlInput1">Delivery Time</label><small class="text-danger">(Only Digit's)</small>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <div class="custom-file">
                                    <input type="file" name="image" id="customFileEg1" class="form-control" onchange="editLoadFile(event)">
