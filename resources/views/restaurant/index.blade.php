                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                            Product (Pending)</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{\App\Models\Product::where([
                            'status'=>'pending', 'restaurant_id'=>Auth::id()])->count()}}</div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                            New Deals (Enabled)</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{\App\Models\Deal::where([
                            'status'=>'1', 'restaurant_id'=>Auth::id()])->count()}}</div>
                    </div>
                    <div class="col-auto">
                        <i class="fas fa-calendar fa-2x text-gray-300"></i>
                    </div>
        ...
        <a href="{{route('restaurants.order.complete-order')}}">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total Order's (Completed)
                            </div>
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
