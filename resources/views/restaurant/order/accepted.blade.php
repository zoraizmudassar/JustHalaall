    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 justify-content-between">
            <div class="row justify-content-between align-items-center">
                <h6 class="ml-3 font-weight-bold">Accepted Orders</h6>
                        ...
                        <div class="col-sm-12">
                            <table class="table table-bordered dataTable" id="dataTable" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                ...
                                <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 70px;">Payment Type</th>
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 63px;">Order Status</th>
                                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 40px;">Place Date</th>
                                ...
                                @foreach($orders as $res)
                                    <tr class="odd">
                                        ...
                                        <td>
                                            ...
                                            <select data-id="{{$res->orderDetails->id}}" class="custom-select custom-select-sm orderStatus" aria-label="Select Status">
                                                @foreach($statuses as $key => $status)
                                                    <option value="{{$status}}" {{ $res->orderDetails->accepted_status == $status ? "selected" : "" }}>{{$status}}</option>
                                                @endforeach
                                            </select>
                                        </td>
                                        <td>
